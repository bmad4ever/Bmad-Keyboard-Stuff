...
source("R/fitness/AuxFunctions.R")
source("R/fitness/V1/KeyFrequencyF.R")
#source("fitness/BigramMovementsFrequencyF.R")
source("R/fitness/V1/top2gramsF.R")
source("R/fitness/V1/top3gramsF.R")
source("R/fitness/V1/top4gramsF.R")
source("R/fitness/V1/top5gramsF.R")
source("R/fitness/constraints/VowelConstraintF.R")
source("R/fitness/constraints/SymbolConstraintF.R")
...
set_powers_weights<- function(efforts, base){
#' @title set_powers_weights:Fitness
#' @description
...
#' @title set_exponential_weights:Fitness
#' @description
...
scorePenalty <- function(ind) {
#' @title scorePenalty:Fitness
#' @description
...
#' @return The sum of all computed the penalties.
  return( penalty.computeTotalPenalty(constraints_list = constraints, individual = ind) )
}
